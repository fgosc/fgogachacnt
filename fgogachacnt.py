...
dist_ce = {
    ...
    '断絶_売却2': np.array([[227, 56, 190, 223, 246, 205, 255, 255]], dtype='uint8'),
    '断絶_売却3': np.array([[227, 184, 190, 115, 188, 219, 222, 207]], dtype='uint8'),
    '断絶_売却4': np.array([[227, 24, 94, 31, 158, 251, 111, 255]], dtype='uint8'),
    '断絶_売却5': np.array([[107, 184, 246, 123, 158, 223, 111, 121]], dtype='uint8'),
    ...
    '暗澹_売却4': np.array([[162, 238, 146, 9, 236, 147, 196, 185]], dtype='uint8'),
    '暗澹_売却5': np.array([[167, 204, 241, 163, 76, 153, 204, 177]], dtype='uint8'),
    '暗澹_売却6': np.array([[3, 204, 209, 187, 236, 59, 206, 155]], dtype='uint8'),
    '暗澹_売却7': np.array([[168, 238, 211, 147, 206, 49, 206, 179]], dtype='uint8'),
    '暗澹_売却8': np.array([[88, 196, 179, 147, 196, 155, 68, 147]], dtype='uint8'),
    '暗澹_売却9': np.array([[57, 102, 123, 33, 100, 57, 76, 185]], dtype='uint8'),
    '連鎖_売却': np.array([[241, 100, 190, 155, 187, 238, 238, 255]], dtype='uint8'),
    }
dist_ce_center = {
    }
dist_ccode = {
...
class ScreenShot:
    ...
    def img2points(self, num):
        ...
        if num == 11:
            pts = [(39, 67, 167, 195), (192, 67, 320, 195),
                   (344, 67, 472, 195),
                   (496, 67, 624, 195), (648, 67, 776, 195),
                   (801, 67, 929, 195),
                   (115, 237, 243, 365), (268, 237, 396, 365),
                   (420, 237, 548, 365),
                   (572, 237, 700, 365), (725, 237, 852, 365)]
        elif num == 10:
            pts = [(39, 67, 167, 195), (192, 67, 320, 195),
                   (344, 67, 472, 195),
                   (496, 67, 624, 195), (648, 67, 776, 195),
                   (801, 67, 929, 195),
                   (192, 237, 320, 365), (344, 237, 472, 365),
                   (496, 237, 624, 365), (648, 237, 776, 365)]
        elif num == 9:
            pts = [(39, 67, 167, 195), (192, 67, 320, 195),
                   (344, 67, 472, 195),
                   (496, 67, 624, 195), (648, 67, 776, 195),
                   (801, 67, 929, 195),
                   (268, 237, 396, 365), (420, 237, 548, 365),
                   (572, 237, 700, 365)]
        elif num == 8:
            pts = [(39, 67, 167, 195), (192, 67, 320, 195),
                   (344, 67, 472, 195),
                   (496, 67, 624, 195), (648, 67, 776, 195),
                   (801, 67, 929, 195),
                   (344, 237, 472, 365), (496, 237, 624, 365)]
        elif num == 7:
            pts = [(39, 67, 167, 195), (192, 67, 320, 195),
                   (344, 67, 472, 195),
                   (496, 67, 624, 195), (648, 67, 776, 195),
            ...
            pts = [(39, 153, 167, 281), (192, 153, 320, 281),
                   (344, 153, 472, 281),
                   (496, 153, 624, 281), (648, 153, 776, 281),
                   (801, 135, 929, 281)]
        elif num == 5:
            pts = [(115, 153, 243, 281), (268, 153, 396, 281),
                   (420, 153, 548, 281), (572, 153, 700, 281),
                   (725, 153, 852, 281)]
        elif num == 4:
            pts = [(192, 153, 320, 281), (344, 153, 472, 281),
                   (496, 153, 624, 281), (648, 153, 776, 281)]
        elif num == 3:
            pts = [(268, 153, 396, 281), (420, 153, 548, 281),
                   (572, 153, 700, 281)]
        elif num == 2:
            pts = [(344, 153, 472, 281), (496, 153, 624, 281)]
        elif num == 1:
            pts = [(420, 153, 548, 281)]
        else:
